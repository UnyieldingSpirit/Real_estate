  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {showLanguages && (
        ...
        >
          <div 
            className={`py-3 px-4 hover:bg-gray-100 cursor-pointer flex justify-center ${
              currentLocale === Locale.RU ? 'bg-gray-200' : ''
            }`}
          ...
          <div 
            className={`py-3 px-4 hover:bg-gray-100 cursor-pointer flex justify-center ${
              currentLocale === Locale.UZ ? 'bg-gray-200' : ''
            }`}
          ...
          <div 
            className={`py-3 px-4 hover:bg-gray-100 cursor-pointer flex justify-center ${
              currentLocale === Locale.EN ? 'bg-gray-200' : ''
            }`}
            onClick={() => selectLanguage(Locale.EN)}
          >
            <span className="font-medium text-[#1F1F1F]">EN</span>
          </div>
        </div>
      )}
    </div>
