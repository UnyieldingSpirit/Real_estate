...
export default function OnboardingSlider() {
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-white  relative">
      ...
      {/* Контентная секция */}
      <div className="h-[45%] flex flex-col justify-between p-4 bg-white rounded-t-[30px] -mt-6 relative z-10">
        <div className="text-center">
          <h1 className="text-[32px] font-black mb-[28px] text-[#1F1F1F]" style={{fontFamily: 'ALS Hauss, sans-serif'}}>
            {slides[currentSlide].title}
          </h1>
          <p className="text-[18px] text-[#1F1F1F] mb-4 leading-relaxed font-normal" style={{fontFamily: 'Inter, sans-serif'}}>
        ...
        <div className="flex flex-col items-center">
          <div 
            className="mb-[46px] w-[103px] h-[103px] flex items-center justify-center bg-[#FF756012] rounded-full cursor-pointer shadow-md"
            onClick={handleNext}
          >
            <BackIcon color="#FF756054" size={22} style={{ transform: 'rotate(180deg)', height: '42px' }} />
          </div>
